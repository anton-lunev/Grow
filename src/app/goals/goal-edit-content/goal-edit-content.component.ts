...
@Component({
  selector: 'grow-goal-edit-content',
  templateUrl: './goal-edit-content.component.html',
  styleUrls: ['./goal-edit-content.component.scss']
})
export class GoalEditContentComponent implements OnInit {
  goal = {
